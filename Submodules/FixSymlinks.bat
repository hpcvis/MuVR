...
rmdir "..\Assets\Thirdparty\FishyVoice"
IF exist "..\Assets\Thirdparty\FishyVoice" del "..\Assets\Thirdparty\FishyVoice"		REM delete it as a file if a folder doesn't yet exist
...
mklink /d "..\Assets\Thirdparty\FishyVoice" "..\..\Submodules\FishyVoice" 
