...
namespace UltimateXR.Devices.Integrations.DeviceSimulator
{
    ...
    public class XRDeviceSimulator : BasePoseProvider
    {
        /// <summary>
        ...
        [SerializeField]
        [Tooltip("Input action asset associated with the simulator. If set will enable the asset automatically.")]
        ...
        {
            get => m_ActionAsset;
            set => m_ActionAsset = value ?? throw new ArgumentNullException(nameof(value));
        }

        public Vector3 initialHMDPosition;
        public Quaternion initialHMDRotation = Quaternion.identity;
        public Vector3 initialLeftPosition;
        public Quaternion initialLeftRotation = Quaternion.identity;
        public Vector3 initialRightPosition;
        public Quaternion initialRightRotation = Quaternion.identity;
        ...
        public XRSimulatedHMDState HMDState => m_HMDState;
        public XRSimulatedControllerState LeftControllerState => m_LeftControllerState;
        public XRSimulatedControllerState RightControllerState => m_RightControllerState;
        ...
        protected virtual void Awake()
        {
            ...
            m_HMDState.centerEyePosition = m_HMDState.devicePosition = initialHMDPosition;
            m_HMDState.centerEyeRotation = m_HMDState.deviceRotation = initialHMDRotation;
            m_CenterEyeEuler = m_HMDState.centerEyeRotation.eulerAngles;

            m_LeftControllerState.devicePosition = initialLeftPosition;
            m_LeftControllerState.deviceRotation = initialLeftRotation;
            m_LeftControllerEuler = m_LeftControllerState.deviceRotation.eulerAngles;
            
            m_RightControllerState.devicePosition = initialRightPosition;
            m_RightControllerState.deviceRotation = initialRightRotation;
        ...
        // Allow overriding tracked pose driver's with the pose provided by this component
        public override PoseDataFlags GetPoseFromProvider(out Pose output) {
            ...
            output.position = HMDState.centerEyePosition;
            output.rotation = HMDState.centerEyeRotation;
        ...
        protected virtual void ProcessPoseInput()
        {
            ...
            if (m_CameraTransform == null)
                throw new ArgumentNullException($"The scene camera must be referenced for the simulator to function!");
        ...
        /// </summary>
        /// <see href="https://docs.unity3d.com/Packages/com.unity.inputsystem@1.2/api/UnityEngine.InputSystem.html#UnityEngine_InputSystem_InputSystem_AddDevice__1_System_String_"/>
        ...
        /// </summary>
        /// <see href="https://docs.unity3d.com/Packages/com.unity.inputsystem@1.2/api/UnityEngine.InputSystem.html#UnityEngine_InputSystem_InputSystem_RemoveDevice_UnityEngine_InputSystem_InputDevice_"/>
